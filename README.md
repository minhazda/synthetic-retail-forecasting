...
> ⚙️ **Looking for the production version?** This repository is the **research artifact**. For the re-engineered, containerized, tested, MLflow-tracked, CI/CD pipeline built to industry standards, see **[synthetic-retail-mlops-pipeline →](https://github.com/minhazda/synthetic-retail-mlops-pipeline)**.
